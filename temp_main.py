...
def main():
    ...
    try:
        ...
        if args.transport == "streamable-http":
            ...
            # Use port 0 to allow dynamic allocation and avoid conflicts (Bug 4 fix)
            ...
            if success:
                ...
                actual_redirect_uri = get_oauth_config().redirect_uri
                safe_print(
                    f"   OAuth callback server started on {actual_redirect_uri}"
                )
            else:
