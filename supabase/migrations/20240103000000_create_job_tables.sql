-- Migration: Create Job Tables and Rate Limiting
-- Description: Creates job_results table for async operations and rate_limit_tracking for abuse prevention
...
BEGIN
  ...
  -- These should be set via Supabase dashboard or config
